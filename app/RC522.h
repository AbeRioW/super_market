...
#define RC522_RST(N) HAL_GPIO_WritePin(SPI1_RST_GPIO_Port,SPI1_RST_Pin,N==1?GPIO_PIN_SET:GPIO_PIN_RESET)
#define RC522_CS(N)  HAL_GPIO_WritePin(SPI1_CS_GPIO_Port,SPI1_CS_Pin,N==1?GPIO_PIN_SET:GPIO_PIN_RESET)
